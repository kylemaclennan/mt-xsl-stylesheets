...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n3="http://www.w3.org/1999/xhtml" xmlns:n1="urn:hl7-org:v3" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      ...
      <xsl:template match="n1:ClinicalDocument">
            <xsl:element name="html">
                  <xsl:element name="head">
                        <xsl:comment>
                              Do NOT edit this HTML directly, it was generated via an XSLT transformation.
                        </xsl:comment>
                  ...
                  <xsl:element name="body">
                        <xsl:attribute name="style">color: black;background-color: white;font-family: Verdana, Tahoma, sans-serif;font-size: 100%;margin-left:35px;</xsl:attribute>
                        <xsl:element name="h2">
                              <xsl:attribute name="style">margin-bottom: 0px;font-weight: bold;font-size: 133%;</xsl:attribute>
                              <xsl:element name="br" />
                        ...
                        <xsl:element name="p" />
                        <xsl:element name="h3">
                              <xsl:attribute name="style">margin-top: 0px;margin-bottom: 0px;font-weight: bold;font-size: 117%;</xsl:attribute>
                        ...
                        <xsl:if test="/n1:ClinicalDocument/n1:participant">
                              ...
                              <xsl:element name="table">
                                    <xsl:attribute name="style">border-width: 1px;border-color: black;border-collapse: collapse;margin-right:auto;margin-left:0px;</xsl:attribute>
                                    <xsl:element name="tr">
                                          <xsl:element name="th">
                                                <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: bold;</xsl:attribute>
                        ...
                        <xsl:if test="/n1:ClinicalDocument/n1:documentationOf/n1:serviceEvent/n1:performer">
                              ...
                              <xsl:element name="table">
                                    ...
                                    <xsl:element name="tr">
                                          <xsl:element name="th">
                                                <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: bold;</xsl:attribute>
                                                <xsl:text>Care Team Member Name</xsl:text>
                                          </xsl:element>
                                          <xsl:element name="th">
                                                <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: bold;</xsl:attribute>
                                                <xsl:text>Role</xsl:text>
                                          ...
                                          <xsl:for-each select="$assigned/n1:telecom">
                                                <xsl:choose>
                                                      <xsl:when test="self::node()[@use='HP']">
                                                            <xsl:element name="tr">
                                                                  <xsl:element name="th">
                                                                        <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight:
                                                                              bold;</xsl:attribute>
                                                                        <xsl:text>Phone</xsl:text>
                                                                  </xsl:element>
                                                                  <xsl:element name="td">
      ...
      <xsl:template name="demographics">
            ...
            <xsl:element name="table">
                  ...
                  <xsl:element name="tr">
                        ...
                        <xsl:element name="td">
                              <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: normal;</xsl:attribute>
                  ...
                  <xsl:if test="$patientRole/n1:addr[2]">
                        <xsl:element name="tr">
                              <xsl:element name="th">
                                    <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: bold;</xsl:attribute>
                                    <xsl:text>Previous Address</xsl:text>
                              </xsl:element>
                              <xsl:element name="td">
                                    <xsl:attribute name="style">border-width: 1px;padding-left: 8px;padding-right: 8px;padding-top: 0.5px;padding-bottom: 0.5px;vertical-align: text-top;border-style: solid;border-color: black;text-align: left;font-weight: normal;</xsl:attribute>
      ...
      <xsl:template match="n1:content">
            <xsl:element name="h4">
                  <xsl:attribute name="style">margin-bottom: 0px;font-weight: bold;</xsl:attribute>
                  <xsl:apply-templates/>
            </xsl:element>
      </xsl:template>
...
****************************************************************************************************************************-->
      ...
      <xsl:template match="n1:table">
            <xsl:element name="br" />
            <xsl:element name="table">
                  <xsl:attribute name="style">border-width: 1px;border-color: black;border-collapse: collapse;margin-right: auto;margin-left: 0px;margin-bottom: 5px;margin-top: 0px;</xsl:attribute>
                  <xsl:apply-templates/>
            </xsl:element>
      </xsl:template>
      ...
      <xsl:template name="getLang">
            ...
            <xsl:choose>
                  ...
                  <xsl:when test="$lang/@code='nob'">
                        <xsl:text>Bokm̴l, Norwegian; Norwegian Bokm̴l</xsl:text>
                  </xsl:when>
                  ...
                  <xsl:when test="$lang/@code='oci'">
                        <xsl:text>Occitan (post 1500); Proven̤al</xsl:text>
                  </xsl:when>
