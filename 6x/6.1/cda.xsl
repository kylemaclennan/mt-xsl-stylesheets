		...
		<body>  
			...
			<ul>
				...
				<xsl:if test="/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:encounterParticipant/n1:assignedEntity">
					<li>
						<span style="color:blue;text-decoration:underline;cursor:pointer;" onclick="Toggle('refferred')">
							<xsl:text>Provider Referred From </xsl:text>
						</span>
					</li>
					<div id="refferred" style="display:none">
...
<xsl:template name="demographics">
	...
	<table summary="Demographics" class="gridtable">
		...
		<xsl:if test="$patientRole/n1:addr[2]">
			<tr>
				<td>
					<b><xsl:text>Previous Address </xsl:text></b>
				</td>			
				<td>
		...
		<tr>
			<td>
				<b><xsl:text>Birth Place</xsl:text></b>
			</td>
			<td>
