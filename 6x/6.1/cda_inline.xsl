...
<xsl:template match="n1:ClinicalDocument">
	<html>
		...
		<body style="color: #000000;background-color: #FFFFFF;font-family: Verdana, Tahoma, sans-serif;font-size: 12px;margin-left:35px;">  
			<xsl:variable name="patientRole" select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole"/>
			<br/>
			<table summary="Demographics" width='100%'>
				<tr>
					<th align='left'>
						<strong>
			...
			<xsl:if test="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:representedOrganization">
				...
				<table summary="Author" style="font-family: verdana,arial,sans-serif;font-size:12px;color:#333333;border-width: 1px;border-color: #000000;border-collapse: collapse;margin: 0px auto;">
					<xsl:if test="$author/n1:representedOrganization">
						<tr>
							<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
								<strong>Organization</strong>
							</th>
							<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
			...
			<xsl:if test="/n1:ClinicalDocument/n1:participant">
				...
				<table summary="Support" style="font-family: verdana,arial,sans-serif;font-size:12px;color:#333333;border-width: 1px;border-color: #000000;border-collapse: collapse;margin: 0px auto;">
					<tr>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Name</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Relationship</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Role</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Address</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Phone</th>
					</tr>
			...
			<xsl:if test="/n1:ClinicalDocument/n1:documentationOf/n1:serviceEvent/n1:performer">
				...
				<table summary="Care Team Providers" style="font-family: verdana,arial,sans-serif;font-size:12px;color:#333333;border-width: 1px;border-color: #000000;border-collapse: collapse;margin: 0px auto;">
					<tr>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Care Team Member Name</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Role</th>
						<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">Phone</th>
					</tr>
...
<xsl:template name="demographics">
	...
	<table summary="Demographics" style="font-family: verdana,arial,sans-serif;font-size:12px;color:#333333;border-width: 1px;border-color: #000000;border-collapse: collapse;margin: 0px auto;">
		...
		<xsl:if test="$patientRole/n1:addr[2]">
			<tr>
				<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
					<strong><xsl:text>Previous Address </xsl:text></strong>
				</th>			
				<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<xsl:for-each select="$patientRole/n1:telecom">
			<xsl:choose>
				...
				<xsl:when test="self::node()[@use='WP']">
					<tr>
						<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
							<strong><xsl:text>Work Phone</xsl:text></strong>	
						</th>			
						<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
							<xsl:call-template name="getTelecom"> 
								<xsl:with-param name="telecom" select="self::node()[@value]"/>
				...
				<xsl:otherwise>
					<tr>
						<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
							<strong><xsl:text>Email Address</xsl:text></strong>	
						</th>			
						<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
							<xsl:call-template name="getEmail"> 
								<xsl:with-param name="email" select="self::node()[@value]"/>
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Preferred Language</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Marital Status</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Religious Affiliation</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Race</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<xsl:if test="$patientRole/n1:patient/sdtc:raceCode">
			<tr>
				<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
					<strong><xsl:text>Additional Race(s)</xsl:text></strong>
				</th>
				<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Ethnic Group</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
		...
		<tr>
			<th align='left' style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
				<strong><xsl:text>Birth Place</xsl:text></strong>
			</th>
			<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
...
<xsl:template match="/n1:ClinicalDocument/n1:documentationOf/n1:serviceEvent/n1:performer">
	<tr>
		...
		<td style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;text-transform: capitalize;">
			<xsl:choose>
...
<xsl:template match="n1:table">
	<table summary="{../../n1:title}" style="font-family: verdana,arial,sans-serif;font-size:12px;color:#333333;border-width: 1px;border-color: #000000;border-collapse: collapse;margin: 0px auto;">
...
<xsl:template match="n1:th">
	<th style="border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;">
			...
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-weight: bold;</xsl:text>
					</xsl:attribute>	
	...
	<xsl:if test="@styleCode='Italics'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-style: italic;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
	...
	<xsl:if test="@styleCode='Underline'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;text-decoration: underline;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
	...
	<xsl:if test="@styleCode='Bold Italics'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-weight: bold; font-style: italic;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
	...
	<xsl:if test="@styleCode='Bold Underline'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-weight: bold; text-decoration: underline;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
	...
	<xsl:if test="@styleCode='Italics Underline'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-style: italic; text-decoration: underline;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
	...
	<xsl:if test="@styleCode='Bold Italics Underline'">
		<xsl:choose>
			<xsl:when test="name() = 'td'">
				<xsl:copy>
					<xsl:attribute name="style">
						<xsl:text>border-width: 1px;padding: 8px;border-style: solid;border-color: #000000;background-color: #ffffff;font-weight: bold; font-style: italic; text-decoration: underline;</xsl:text>
					</xsl:attribute>	
					<xsl:apply-templates select="node()"/> 
				</xsl:copy>
			</xsl:when>
