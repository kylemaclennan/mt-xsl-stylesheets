...
<xsl:element name="html">
	<xsl:element name="head">
		<xsl:comment> Do NOT edit this HTML directly, it was generated via an XSLT transformation.</xsl:comment>
	...
	<xsl:element name="body">
		...
		<xsl:element name="div">
			...
			<xsl:copy-of select="document('customer_detail.xml')/detail/footer/p"/>
		</xsl:element>
	</xsl:element>
</xsl:element>
</xsl:template>
...
<xsl:template name="header">
	<xsl:element name="table">
			...
			<xsl:attribute name="class">header_table</xsl:attribute>
			<xsl:element name="tr">
				<xsl:element name="th">
					<xsl:element name="div">
						<xsl:attribute name="id">header</xsl:attribute>
						<xsl:value-of select="document('customer_detail.xml')/detail/header/address1"/>
					</xsl:element>
				</xsl:element>
				<xsl:element name="td">
					<xsl:element name="b">
			...
			<xsl:element name="tr">
				<xsl:element name="th">
					<xsl:element name="div">
						<xsl:attribute name="id">header</xsl:attribute>
						<xsl:value-of select="document('customer_detail.xml')/detail/header/address2"/>
					</xsl:element>
				</xsl:element>
				<xsl:element name="td">
					<xsl:element name="b">
						<xsl:text>Medical Record: </xsl:text>
					</xsl:element>
			...
			<xsl:element name="tr">
				<xsl:element name="th">
					<xsl:element name="div">
						<xsl:attribute name="id">header</xsl:attribute>
						<xsl:value-of select="document('customer_detail.xml')/detail/header/address3"/>
					</xsl:element>
				</xsl:element>
				<xsl:element name="td">
					<xsl:element name="b">
			...
			<xsl:if test="document('customer_detail.xml')/detail/header/address4">
				<xsl:element name="tr">
					<xsl:element name="th">
						<xsl:element name="div">
							<xsl:attribute name="id">header</xsl:attribute>
							<xsl:value-of select="document('customer_detail.xml')/detail/header/address4"/>
						</xsl:element>
					</xsl:element>
				</xsl:element>
			</xsl:if>
...
<xsl:template name="demographics">
	...
	<xsl:element name="table">
		<xsl:attribute name="class">main_table</xsl:attribute>
		<xsl:element name="tr">
			<xsl:element name="th">
				<xsl:text>Patient Name</xsl:text>
			</xsl:element>
...
<xsl:template name="support">
	...
	<xsl:element name="h3">
		<xsl:element name="div">
			<xsl:attribute name="class">section_title</xsl:attribute>
...
<xsl:template match="n1:content[@styleCode='Bold center']">
	<xsl:element name="div">
		<xsl:attribute name="class">content_header</xsl:attribute>
		<xsl:apply-templates/>
	</xsl:element>
</xsl:template>
